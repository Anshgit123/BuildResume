...
const StepProgress = ({progress}) => {
  return (
    ...
    border border-white/10'>
        <div className='absolute inset-0 b-gradient-to-r from-violet-500/20 to-fuchsia-500/20 animate-pulse'/>

        <div className='relative h-fulll bg-gradient-to-r from-violet-500 via-fuchsia-500 to-violet-600
