  ...
  return (
    <div className='max-w-7xl mx-auto px-4'>
        ...
        p-4 sm:p-6 bg-gradient-to-r from-white to-violet-50 rounded-2xl border border-violet-100'>
            ...
            <button className='w-full sm:w-auto flex items-centerr justify-center gap-3 px-6 py-3 bg-gradient-to-r
            from-violet-600 to-fuchsia-600 text-white font-black rounded-2xl hover:scale-105
            transition-all shadow-l hover:shadow-xl' onClick={handleThemeSelection}>
                <Check size={18} /> Apply Changes
            </button>
        </div>
        <div className='grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8'>
            <div className='lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-4 sm:p-6'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 mx-h-[60vh] lg:max-h-[70vh]
                overflow-auto p-2'>
            ...
            <div className='lg:col-span bg-white rounded-2xl border border-gray-100 p-4 sm:p-6' ref={resumeRef}>
