...
export const TemplateCard =({thumbnailImg, isSelected, onSelect}) => {
  return (
    <div className={`griup h-auto md:h-[300px] lg:h-[320px] flex flex-col bg-white border-2 overflow-hidden
    ...
    ${
      ...
      {thumbnailImg ? (
        <div className='relative w-full h-full overflow-hidden'>
          ...
          {isSelected &&(
            <div className="absolute inset-0 bg-violet-500/10 flex items-center justify-center">
              <div className="w-16 h-16 bg-white background-blur-sm rounded-full flex items-center
        ...
        via-violet-600  to-fuchsia-50">
          <div className="w-12 h-12 bg-gradient-to-br from-violet-500 to-fuchsia-500 rounded-2xl fles
