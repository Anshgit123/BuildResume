export const landingPageStyles = {
  ...
  // Hero section
  heroSection: "relative py-10 bg-gradient-to-br from-slate-50 via-white to-violet-50",
  heroGrid: "grid grid-cols-1 md:grid-cols-2 items-center gap-8 relative max-w-6xl mx-auto px-4",
  heroLeft: "space-y-6 relative z-20", 
  ...
  headingGradient: "relative bg-gradient-to-r from-violet-700 via-fuchsia-600 to-orange-500 bg-clip-text text-transparent drop-shadow-lg text-gray-900",
  ...
  // Hero illustration
  heroIllustration: "flex justify-center items-center relative z-15",
  heroIllustrationBg: "absolute -inset-8 bg-gradient-to-r from-violet-200/50 to-fuchsia-200/50 rounded-3xl blur-3xl",
  heroIllustrationContainer: "w-full h-full max-w-md bg-white rounded-3xl shadow-2xl p-5 z-15",

  // SVG styles
  svgContainer: "w-full max-w-[500px] h-auto block",
  ...
  // Features section
  featuresSection: "relative py-20 bg-gradient-to-br from-slate-50 via-white to-violet-50",
...
export const educationStyles = {
  container: "space-y-6",
  heading: "text-xl font-bold text-slate-800 mb-4",
  item: "p-4 border rounded-lg bg-white shadow-sm",
  textarea: "w-full p-2 border rounded-md focus:ring focus:ring-violet-300",
  addButton: "bg-violet-500 text-white px-4 py-2 rounded-lg hover:bg-violet-600",
};
